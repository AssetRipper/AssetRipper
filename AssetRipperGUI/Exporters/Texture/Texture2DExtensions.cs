...
using KTXFormat = AssetRipperGUI.TextureContainers.KTX.KTXInternalFormat;
using KTXBaseFormat = AssetRipperGUI.TextureContainers.KTX.KTXBaseInternalFormat;
using PVRFormat = AssetRipperGUI.TextureContainers.PVR.PVRPixelFormat;
