...
public sealed class RegistryPackageBridge
{
	...
	private static readonly Dictionary<string, FamilyHint> FamilyHints = new(StringComparer.Ordinal)
	{
		...
		["Fusion.Common.dll"] = new("photon_fusion", "Photon Fusion", null, ["fusion"]),
		["Fusion.Log.dll"] = new("photon_fusion", "Photon Fusion", null, ["fusion"]),
		["Fusion.Realtime.dll"] = new("photon_fusion", "Photon Fusion", null, ["fusion"]),
		["Fusion.Runtime.dll"] = new("photon_fusion", "Photon Fusion", null, ["fusion"]),
		["Fusion.Sockets.dll"] = new("photon_fusion", "Photon Fusion", null, ["fusion"]),
		["Fusion.Unity.dll"] = new("photon_fusion", "Photon Fusion", null, ["fusion"]),
		["PhotonRealtime.dll"] = new("photon_realtime", "Photon Realtime", null, ["photon", "realtime"]),
		["PhotonUnityNetworking.dll"] = new("photon_pun_2", "Photon PUN 2", null, ["photon.pun", "punversion"]),
		["modio.UnityPlugin.dll"] = new("modio_unity_plugin", "mod.io Unity Plugin", null, ["mod.io", "modio"]),
		["Oculus.VR.dll"] = new("oculus_integration", "Oculus Integration", null, ["oculus", "ovr"]),
