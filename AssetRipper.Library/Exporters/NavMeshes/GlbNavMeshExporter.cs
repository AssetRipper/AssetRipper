...
namespace AssetRipper.Library.Exporters.NavMeshes
{
	public sealed class GlbNavMeshExporter : BinaryAssetExporter
	{
		...
		private static void AddAssetToSceneBuilder(SceneBuilder sceneBuilder, INavMeshData asset)
		{
			...
			foreach (IHeightMeshData heightMeshData in asset.HeightMeshes_C238)
			{
				...
				AssetList<Vector3f_3_5_0_f5> vertices = heightMeshData.Vertices;
		...
		private static VertexBuilder<VertexPosition, VertexEmpty, VertexEmpty> FromVector(Vector3f_3_5_0_f5 vector)
		{
