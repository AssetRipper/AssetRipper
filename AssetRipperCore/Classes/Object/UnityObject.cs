...
{
	public abstract class UnityObject : IAsset, IDependent
	{
		protected UnityObject(AssetLayout layout) { }

		protected UnityObject(AssetInfo assetInfo)
		{
			AssetInfo = assetInfo;
		}

		public virtual UnityObject Convert(IExportContainer container)
		{
			return this;
		}
		...
		public virtual IEnumerable<PPtr<UnityObject>> FetchDependencies(DependencyContext context)
		{
			yield break;
		}
