...
namespace AssetRipper.Converters.Classes.Sprite
{
	...
	{
		public static SpriteMetaData GenerateSpriteMetaData(IExportContainer container, SpriteAtlas originAtlas, Parser.Classes.Sprite.Sprite origin)
		{
			...
			{
				if (Parser.Classes.Sprite.Sprite.HasPhysicsShape(container.Version))
				{
			...
			{
				if (Parser.Classes.Sprite.Sprite.HasBones(container.Version))
				{
...
#warning TODO:
		...
		private static Vector2f[][] GetPhysicsShape(IExportContainer container, SpriteAtlas originAtlas, Parser.Classes.Sprite.Sprite origin, Rectf rect, Vector2f pivot)
		{
			if (Parser.Classes.Sprite.Sprite.HasPhysicsShape(container.Version))
			{
		...
		private static int[] GetBoneIndices(IExportContainer container, Parser.Classes.Sprite.Sprite origin)
		{
