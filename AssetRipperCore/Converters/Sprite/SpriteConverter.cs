...
namespace AssetRipper.Converters.Sprite
{
	...
	{
		public static SpriteMetaData GenerateSpriteMetaData(IExportContainer container, SpriteAtlas originAtlas, AssetRipper.Classes.Sprite.Sprite origin)
		{
			...
			{
				if (AssetRipper.Classes.Sprite.Sprite.HasPhysicsShape(container.Version))
				{
			...
			{
				if (AssetRipper.Classes.Sprite.Sprite.HasBones(container.Version))
				{
...
#warning TODO:
		...
		private static Vector2f[][] GetPhysicsShape(IExportContainer container, SpriteAtlas originAtlas, AssetRipper.Classes.Sprite.Sprite origin, Rectf rect, Vector2f pivot)
		{
			if (AssetRipper.Classes.Sprite.Sprite.HasPhysicsShape(container.Version))
			{
		...
		private static int[] GetBoneIndices(IExportContainer container, AssetRipper.Classes.Sprite.Sprite origin)
		{
